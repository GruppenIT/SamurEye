...
# ============================================================================
# 14. CRIAR TABELAS ESSENCIAIS POSTGRESQL  
# ============================================================================

log "📋 Criando tabelas essenciais no PostgreSQL..."

# Aguardar PostgreSQL estar completamente disponível
sleep 5

# Criar tabelas essenciais diretamente no PostgreSQL
log "📝 Criando tabelas essenciais (tenants, users, collectors)..."
